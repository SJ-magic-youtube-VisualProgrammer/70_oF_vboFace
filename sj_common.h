...
public:
	...
	****************************************/
	...
	ofxGuiGroup Group_common;
		ofxToggle b_webCam_Gray;
	
	ofxGuiGroup Group_Particle;
		ofxFloatSlider ParticleSpace;
		ofxFloatSlider ParticleHeight;
		ofxFloatSlider ParticleAlpha;
		ofxFloatSlider ParticlePointSize;
		ofxToggle b_Particle_Mirror;
		
	ofxGuiGroup Group_Back;
		ofxFloatSlider Alpba_img;
		ofxFloatSlider Alpba_webCam;
